; ****************************************************************************
; forktest.s - TRDOS 386 (TRDOS v2.0) Kernel - 'sysfork' test
; ----------------------------------------------------------------------------
;
; 12/11/2017
;
; [ Last Modification: 12/11/2017 ]
;
; RETRO UNIX 386 (Retro Unix == Turkish Rational Unix)
; Operating System Project (v0.2) by ERDOGAN TAN (Beginning: 24/12/2013)
;
; Derived from 'Retro UNIX 386 v1' FORK TEST source code by Erdogan Tan
; ('forkstest.s', 17/09/2015)
;
; ****************************************************************************
