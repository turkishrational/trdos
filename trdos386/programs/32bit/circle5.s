; ****************************************************************************
; circle5.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 15/02/2021
;
; ****************************************************************************
; nasm circle5.s -l circle5.txt -o CIRCLE5.PRG -Z error.txt
; (modified from 'circle4.s', 15/02/2021)

; Draw circle by using 'sysvideo' bx=0306h
...
write_circle:
	...
	shr	edx, 3 ; / 8
	; edx = pixel count
	; esi = user's multi colors pixel buffer address
	sys	_video, 0306h
