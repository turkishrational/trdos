; ****************************************************************************
; circle18.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 07/03/2021
;
; ****************************************************************************
; nasm circle18.s -l circle18.txt -o CIRCLE18.PRG -Z error.txt
; (modified from 'circle17.s', 07/03/2021)

; Draw circle by using 'sysvideo' bh=3 (VESA VBE mode version, 1024*768*32bpp)
...
write_pixel:
	; convert pixel offset to 32bpp offset (*4)
	shl	eax, 2

	sys	_video, 0301h, [color], eax
	retn  
