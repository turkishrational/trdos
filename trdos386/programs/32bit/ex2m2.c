...
int main(int argc, char **argv)
{
    ...
    // Komut satırı argümanlarını ve crt0 yığın zaafını tamamen bypass ediyoruz!
    printf("TRDOS 386 Yerel Ex2 Test Modu Aktif\n");

    // Test Senaryosu: 4 basic operations kullanarak 24 sayısını bulmaya çalışalım
    // Sayılarımız: 1, 2, 3, 4 olsun. (Örn: 1 * 2 * 3 * 4 = 24 veya (3+1)*(4+2)=24)
    ctx.result = 24; 
    printf("Hedef Sonuc (Result) = %d\n", ctx.result);
