; ****************************************************************************
; getticks.s (TRDOS 386, TRDOS v2.0.11 - sample binary file, 'getticks.prg')
; ----------------------------------------------------------------------------
; GETTICKS.PRG ! 'systime' TEST program for TRDOS 386 !
;
; 15/05/2026
;
; [ Last Modification: 15/05/2026 ]
;
; ****************************************************************************
; nasm getticks.s -l getticks.txt -o getticks.PRG
...
hz100_to_time:
	; eax = 100 Hz tick count
	xor	edx, edx
	mov	ecx, 100
	div	ecx
	; eax = seconds
	cmp	edx, 50
	jnb	short seconds_to_time_@
	jmp	short seconds_to_time
