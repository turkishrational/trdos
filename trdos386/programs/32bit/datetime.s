; ****************************************************************************
; datetime.s (TRDOS 386, TRDOS v2.0.11 - sample binary file, 'datetime.prg')
; ----------------------------------------------------------------------------
; DATETIME.PRG ! "Day of Week" - 'systime' TEST program for TRDOS 386 !
;
; 09/05/2026
;
...
;
; ****************************************************************************
; nasm datetime.s -l datetime.txt -o DATETIME.PRG
...
START_CODE:
	...
	; Get Date&Time in MSDOS (FAT/DIRENTRY) format (1980->0)
	sys	_time, 6

	; EAX (time) bits = hhhhhmmmmmmsssss
