; ****************************************************************************
; blocks15.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 02/03/2021 (01/03/2021)
;
; ****************************************************************************
; nasm blocks15.s -l blocks15.txt -o BLOCKS15.PRG -Z error.txt
...
_l2s4:
	...
	mov	edi, 0FF00h ; mask color, GREEN
	mov	ecx, 808080h
	mov	edx, 240*65536+40 ; column 240, row 130
