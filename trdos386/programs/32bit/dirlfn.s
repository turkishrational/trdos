; ****************************************************************************
; dirlfn.s (TRDOS 386, TRDOS v2.0.11 - sample binary file, 'dirlfn.prg')
; ----------------------------------------------------------------------------
; DIRLFN.PRG ! 'sysfff' and 'sysfnf' TEST program for TRDOS 386 !
;
; 30/04/2026
;
...
msg_program:
	db 0Dh, 0Ah
	db "DIRLFN.PRG /// TRDOS 386 sysfff, sysfnf test program"
	db 0Dh, 0Ah
...
LFN:	resb 260 ; Long File Name buffer
	resd 4
