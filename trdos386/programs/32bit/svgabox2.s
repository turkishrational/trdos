; ****************************************************************************
; svgabox2.s - TRDOS 386 (TRDOS v2.0.3) Test Program - LFB data transfers
; ----------------------------------------------------------------------------
;
; 28/01/2021
;
; ****************************************************************************
; nasm svgabox2.s -l svgabox2.txt -o SVGABOX2.PRG -Z error.txt

; Modified from svgabox1.s (26/01/2021)
; (this version is using 'sysvideo' function bx=0201h instead of LFB mapping)
