; ****************************************************************************
; line3.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel w/r tests
; ----------------------------------------------------------------------------
;
; 10/02/2021
;
; ****************************************************************************
; nasm line3.s -l line3.txt -o LINE3.PRG -Z error.txt
; (modified from 'line1.s', 09/02/2021)

; Draw lines by using 'sysvideo' bx=010Eh
