...
;
; ****************************************************************************
; nasm setdate2.s -l setdate2.txt -o SETDATE2.PRG

; modified from "setdate.s" (18/05/2026) and "setdow.s" (17/05/2026)
...
p_date:
	...
	; Set day of the week according to the date
	push	dword [day]
	push	dword [month]
	push	dword [year]
	...
	mov	ecx, eax ; 0 = sunday	
	inc	ecx	; (1 = sunday, 7 = saturday)
	
	; Set Day Of The Week (bl = 11)
	sys	_stime, 11
