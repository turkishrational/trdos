...
;
; ****************************************************************************
; nasm setticks.s -l setticks.txt -o setticks.PRG
...
getchar:
	...
	; Set (18.2Hz) System Timer Ticks (bl = 4)
	sys	_stime, 4, [tick_count]
	jc	short p_nextline
...
confirm:
	db 0Dh,0Ah
	db "Press ENTER to save/apply 18.2 Hz tick count",0Dh,0Ah
...
limit:
	db 0Dh,0Ah
	db "Input error: Maximum 1573041 ticks applicable !"
	db 0Dh,0Ah,0
