; ****************************************************************************
; cdate.s (TRDOS 386, TRDOS v2.0.11 - sample binary file, 'cdate.prg')
; ----------------------------------------------------------------------------
; CDATE.PRG ! Date & Time - 'systime' TEST program for TRDOS 386 !
;
; 09/05/2026
;
...
;
; ****************************************************************************
; nasm cdate1.s -l cdate1.txt -o CDATE1.PRG
...
START_CODE:
	...
	; Get Date in MSDOS (TRDOS 386) format (1980->1980)
	sys	_time, 2

	; EAX = Current System Date (RTC)
	;  AL = Day (AL in MSDOS)
	;  AH = Month (AH in MSDOS)
	;  HW of EAX = Year (AX in MSDOS)
