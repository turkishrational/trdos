; ****************************************************************************
; sdate.s (TRDOS 386, TRDOS v2.0.11 - sample binary file, 'sdate.prg')
; ----------------------------------------------------------------------------
; SDATE.PRG ! "Get/Set Date" - "systime" & 'sysstime' TEST program !
;
; 18/05/2026
;
...
;
; ****************************************************************************
; nasm sdate.s -l sdate.txt -o SDATE.PRG
...
show_date:
	...
	; Get Date in MSDOS format (1980->1980) ((BL = 2))
	sys	_time, 2
