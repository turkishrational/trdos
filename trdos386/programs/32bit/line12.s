; ****************************************************************************
; line12.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 07/03/2021
;
; ****************************************************************************
; nasm line12.s -l line12.txt -o LINE12.PRG -Z error.txt
; (modified from 'line11.s', 07/03/2021)

; Draw lines by using 'sysvideo' bx=022Eh (VESA VBE mode version)
...
START_CODE:
	...
	sys	_video, 08FFh, 112h  ;640*480, 24bpp
