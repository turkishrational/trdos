; ****************************************************************************
; blocks9.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 28/02/2021 (27/02/2021)
;
; ****************************************************************************
; nasm blocks9.s -l blocks9.txt -o BLOCKS9.PRG -Z error.txt
; (modified from 'blocks3.s', 23/02/2021)

; 'sysvideo' bh = 2, block copy and modification test (VESA VBE mode 112h)
; (640*480, 24 bit true colors version)
