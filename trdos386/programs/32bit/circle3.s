; ****************************************************************************
; circle3.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 14/02/2021
;
; ****************************************************************************
; nasm circle3.s -l circle3.txt -o CIRCLE3.PRG -Z error.txt
; (modified from 'circle2.s', 14/02/2021)

; Draw circle by using 'sysvideo' bh=3 (VESA VBE mode version, 1024*768*8bpp)
