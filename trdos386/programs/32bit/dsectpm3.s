...
; dsectpm2.s (07/07/2016, TRDOS 386 v1 application, protected mode program)
; 
; Assembler: NASM 2.11
...
[BITS 32]
	...
	;; 22/11/2020
	;; set current sectors (of all possible disk drives)
	;; to invalid value
	;xor	eax, eax
	;dec	eax  ; 0FFFFFFFFh
	;mov	edi, ds_sec
	;mov	cl, 6 ; 6 physical disk drives
	;rep	stosd
...
dscl_getc:
	...
	; 29/08/2020
	;cmp	ax, F1Key
	cmp	ah, F1Key ; 07/02/2021
	jb	dscl_6	
	je	short dscl_0 ; [dscmd] = 0
	; 28/08/2020
	;cmp	ax, F4Key
	cmp	ah, F4Key ; 07/02/2021
...
dscl_29:
	;cmp	ax, HOMEKey
	cmp	ah, HOMEKey ; 07/02/2021
	jne	short dscl_7
	xor	eax, eax
	jmp	short dscl_11
dscl_7:
	;cmp	ax, ENDKey
	cmp	ah, ENDKey ; 07/02/2021
	jne	short dscl_8
...
prg_msg:
	...
	;;db 'by Erdogan Tan  [27/10/2020]'  ; LBA disk (>8GB) bugfix
	;db 'by Erdogan Tan  [22/11/2020]' ; Video page size bugfix
	db 'by Erdogan Tan  [07/02/2021]' 
				; Fix for key scan-ascii codes in QEMU
	db 0Dh, 0Ah, 0Dh, 0Ah
