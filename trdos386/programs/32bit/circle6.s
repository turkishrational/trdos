; ****************************************************************************
; circle6.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
;
; 16/02/2021 (15/02/2021)
;
; ****************************************************************************
; nasm circle6.s -l circle6.txt -o CIRCLE6.PRG -Z error.txt
; (modified from 'circle4.s', 15/02/2021)
...
_ss_x:
	...
	mov	byte [prevd], 200
	mov	byte [prevx], 320/2 
	mov	byte [prevy], 200/2
