; ****************************************************************************
; EPFORMAT.ASM (EPFORMAT.COM) - Retro DOS v5 Hard Disk Formatting Utility
; (R5EPFORM.S - R5EPFORM.COM)
; ----------------------------------------------------------------------------
...
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15 (r5epform.s)
; ----------------------------------------------------------------------------
; Modified from 'rdepform.s'(RDEPFORM.COM) source code by Erdogan Tan
; (04/05/2024) - Retro DOS v4 hard/fixed disk formatting utility -
; ****************************************************************************
; Copyright (C) 2020-2024 Erdogan TAN
; ****************************************************************************
; assembling: nasm r5epform.s -l r5epform.txt -o R5EPFORM.COM -Z error.txt
...
T_15:
	...
	mov	si, RD_ep_ldd_defect ; not a logical dos drive
	jmp	T_40
...
T_49:
	...
	; Temporary FAT32 note for Retro DOS v4
	; (This code will be removed when the Retro DOS v5
	;  FAT32 boot sector code will be ready.)" ; 28/10/2023
...
RD_Welcome:
	...
	db 0Dh, 0Ah
	db 0Dh, 0Ah
	db 'RDEPFORM v2.0.260129 (c) Erdogan TAN 2020-2026 '
	db 0Dh,0Ah
	db 0Dh,0Ah
...
RD_Do_you_want:
	db 0Dh, 0Ah
	db 0Dh, 0Ah
	db "Do you want to format logical DOS drive as Retro DOS v4 FAT" 
fattype_str:
	db "16 fs ? (Y/N) "
	db 0
