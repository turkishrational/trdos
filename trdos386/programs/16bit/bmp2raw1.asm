...
input_file      db "CAR.BMP", 0        ; Dönüstürülecek 256 renk BMP görseli
output_file     db "CAR.BIN", 0        ; Olusacak saf raw piksel dosyasi

msg_success     db "Basariyla donusturuldu: CAR.BIN", 0Dh, 0Ah, "$"
