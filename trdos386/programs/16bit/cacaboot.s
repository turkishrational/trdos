; ****************************************************************************
; CACABOOT.ASM - ROMBIOS hacking by Erdogan Tan
; ----------------------------------------------------------------------------
; Special fd boot sector for ROMBIOS (Int 13h etc.) (reverse bios engineering)
; ((for TRDOS 386 v2 project, for SATA,USB disk functions in protected mode))
; ----------------------------------------------------------------------------
; Beginning & Last Update: 19/01/2024
; ----------------------------------------------------------------------------
; Assembler: NASM version 2.15
; ----------------------------------------------------------------------------
; nasm cacaboot.s -l cacaboot.lst -o CACABOOT.BIN -Z error.txt
; ----------------------------------------------------------------------------
; Assembled/Compiled boot sector must be copied to fd0 sector 0 (bootable fd)
; ****************************************************************************

; Modified from gagaboot2.s (09/11/2020) - GAGABOOT v2 -
...
program_info:
		db	0Dh, 0Ah
		db	"CACABOOT v1 for ROMBIOS hacking by Erdogan Tan [19/01/2024]"
		db	0Dh, 0Ah
		db	0Dh, 0Ah
