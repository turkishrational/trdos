...
input_file      db "CAR_L.BMP", 0      ; Dönüstürülecek 256 renk BMP görseli
output_file     db "CAR_L.BIN", 0      ; Olusacak saf raw piksel dosyasi

msg_success     db "Basariyla donusturuldu: CAR_L.BIN", 0Dh, 0Ah, "$"
