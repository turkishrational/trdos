; ****************************************************************************
; TRDOS386.ASM (TRDOS 386 Kernel) - v2.0.2 - hdformat.s
; ----------------------------------------------------------------------------
; Primary DOS Partition (FAT File System) Format Utility for TRDOS 386 v2 OS.
; ----------------------------------------------------------------------------
; Last Update: 25/09/2020
; ----------------------------------------------------------------------------
; Beginning: 11/09/2020
; ----------------------------------------------------------------------------
...
M_2:
	...
	; (less than the minimum numbe rof sectors required)
...
TrDOS_Do_you_want:
	db 0Dh, 0Ah
	db 0Dh, 0Ah
	db "Do you want to format DOS partition as TRDOS 386 FAT" 
fattype_str:
	db "16 fs ? (Y/N) "
	db 0
